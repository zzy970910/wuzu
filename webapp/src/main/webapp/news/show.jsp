...
<script type="text/javascript">
        ...
        $('#newsselect').datagrid({
            ...
            columns:[[
                ...
                {field:"button",title:'操作',width:100,align:'center',
                    formatter: function(value,row,index){
                        return "<input type='button'  class='icon-remove' onclick='deleteNews("+row.newsId+")' value='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'>删除&nbsp;&nbsp;&nbsp;<input type='button'  class='icon-edit' onclick='updateNews("+row.newsId+")' value='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'>修改";
                    }
                }
            ]]
    ...
    function addwindC(){
        $("#dialog_add").dialog({
            ...
            closed: false,
            cache: false,
            href:"<%=request.getContextPath()%>/news/add.jsp",
            modal: true ,
            buttons:[{
                text:'保存',
                iconCls:'icon-edit',
